...
const MORNING = [{name: "Now", subpages: [{name: "radar-page", duration: 9000}, {name: "radar-page", duration: 8000}]},{name: "Today", subpages: [{name: "today-page", duration: 10000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 10000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 10000}, {name: "7day-page", duration: 13000}]},]
...
const crawlSpeedFast = 10; // A fast reading pace, in characters per second
const crawlScreenTime = 15; // Shortest time crawl will be on screen, in seconds
