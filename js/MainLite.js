...
const MORNING = [{name: "Now", subpages: [{name: "current-page", duration: 10000}, {name: "radar-page", duration: 0}]},{name: "Today", subpages: [{name: "today-page", duration: 11000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 11000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 11000}, {name: "7day-page", duration: 11000}]},]
const NIGHT = [{name: "Now", subpages: [{name: "current-page", duration: 10000}, {name: "radar-page", duration: 0}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 10000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 10000}, {name: "tomorrow-night-page", duration: 11000}, {name: "7day-page", duration: 11000}]},]
const SINGLE = [{name: "Alert", subpages: [{name: "single-alert-page", duration: 7000}]},{name: "Now", subpages: [{name: "current-page", duration: 9000}, {name: "radar-page", duration: 0}, {name: "zoomed-radar-page", duration: 0}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 9000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 9000}, {name: "7day-page", duration: 11000}]},]
const MULTIPLE = [{name: "Alerts", subpages: [{name: "multiple-alerts-page", duration: 7000}]},{name: "Now", subpages: [{name: "current-page", duration: 9000}, {name: "radar-page", duration: 0}, {name: "zoomed-radar-page", duration: 0}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 9000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 8000}, {name: "7day-page", duration: 11000}]},]
