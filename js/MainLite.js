...
const MORNING = [{name: "Now", subpages: [{name: "current-page", duration: 12000}, {name: "radar-page", duration: 0}]},{name: "Today", subpages: [{name: "today-page", duration: 13000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 13000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 13000}, {name: "7day-page", duration: 13000}]},]
const NIGHT = [{name: "Now", subpages: [{name: "current-page", duration: 12000}, {name: "radar-page", duration: 0}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 13000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 13000}, {name: "tomorrow-night-page", duration: 13000}, {name: "7day-page", duration: 13000}]},]
const SINGLE = [{name: "Alert", subpages: [{name: "single-alert-page", duration: 9000}]},{name: "Now", subpages: [{name: "current-page", duration: 11000}, {name: "radar-page", duration: 0}, {name: "zoomed-radar-page", duration: 0}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 11000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 11000}, {name: "7day-page", duration: 13000}]},]
